...
def render_cloth(cam, _texture, texture_v2d, faces, imHuman):
    ...
    # 1. texture rendering
    dist = 20.0
    cloth_renderer = smpl3dclothrec_v4.build_texture_renderer(cam, cam.v, faces, texture_v2d, faces,
    ...
    overlay_renderer = smpl3dclothrec_v4.build_texture_renderer(cam, cam.v, faces, texture_v2d, faces, texture[::-1, :, :], w, h, 1.0, near=0.5, far=20 + dist, background_image=imBG)
...
def cloth3dxfer_single(smpl_model, src_param_path, tgt_param_path, cloth_path, clothmask_path, human_path, human_segm_path, ocloth_path, oclothfull_path, omask_path):
    ...
    params_src, body, diff_cloth_body, texture, texture_v2d, face4cloth = smpl3dclothrec_v4.cloth3drec_single(
    ...
    body_tgt_sv = smpl3dclothrec_v4.build_smplbody_surface(
